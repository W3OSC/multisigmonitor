...
CREATE INDEX idx_last_checks_safe_network ON last_checks(safe_address, network);
...
CREATE INDEX idx_notification_status_tx ON notification_status(transaction_hash);
